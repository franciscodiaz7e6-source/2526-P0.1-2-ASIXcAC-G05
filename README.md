...
| **Sección** | **Carpeta** | **Acceso Directo** |
|---------------|----------------|----------------------|
| **Gestión & Actas** | `01-gestion/` | [Ver actas →](./docs/01-gestion/actas/indice-acta.md) |
| **Arquitectura** | `02-arquitectura/` | [Ver arquitectura →](./docs/02-arquitectura/000-indice-arquitectura.md) |
| **Manuales** | `03-manuales/` | [Ver manuales →](./docs/03-manuales/000-indicemanuales.md) |
| **Pruebas** | `04-pruebas/` | [Ver pruebas →](./docs/04-pruebas/indicepruebas.md) |
